...
- Полная поддержка работы в топиках Telegram групп
- Команды `/menu` и `/start` работают в любом топике
- Бот отвечает в том же топике, где была вызвана команда
- Подробнее: [Настройка для топиков](TOPICS_SETUP_GUIDE.md)
